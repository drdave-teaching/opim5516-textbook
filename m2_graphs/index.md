...
In PyTorch (with PyTorch Geometric), swapping one for the other is essentially a one-line change — and seeing that is the point. The abstraction is clean: define the message-passing layer, and the framework handles the graph plumbing.
